...
import edu.touro.mco152.bm.ui.SwingUIHandler;
...
public class App {
    ...
    public static void startBenchmark() {
        ...
        BenchmarkUIHandler uiHandler = new SwingUIHandler();
        App.readTest = uiHandler.shouldDoReadBenchmark();
        worker = new DiskWorker(uiHandler);
